...
log_path = "/home/lucas/masters/sci-image-markdown/eval.log"
with open(log_path, "w") as f:
    proc = subprocess.Popen(
        [
            "/bin/bash",
            "/home/lucas/masters/sci-image-markdown/run_eval_both.sh"
        ],
    ...
    with open("/home/lucas/masters/sci-image-markdown/eval.pid", "w") as pf:
